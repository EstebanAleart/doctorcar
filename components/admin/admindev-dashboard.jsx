...
export function AdminDevDashboard() {
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto p-4 md:p-6">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4 md:space-y-6">
          <TabsList className="grid w-full grid-cols-2 gap-2 h-auto md:grid-cols-5 lg:grid-cols-9 lg:w-auto lg:inline-grid">
            ...
            <TabsTrigger value="desarrollo" className="text-xs md:text-sm">Desarrollo</TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="desarrollo" className="space-y-6">
            {/* Aquí va el registro y listado de pagos de desarrollo */}
            <div className="p-6 bg-muted rounded-lg">Funcionalidad de registro de pagos de desarrollo pendiente de implementación.</div>
          </TabsContent>
        </Tabs>
      </div>
    </div>
